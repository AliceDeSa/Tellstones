        ...
        mesa.forEach((p, i) => {
            ...
            if (p.virada) {
                ...
                if (url && url.indexOf("assets/themes/Taberna/img/stones/demacia") === -1 && url.indexOf("assets/img/stones/new_set") === -1 && url.indexOf("assets/themes/Taberna/img/coins") === -1) {
                    ...
                    if (url.includes("Coroa")) url = "assets/themes/Taberna/img/stones/demacia/Coroa.svg";
                    else if (url.includes("espada")) url = "assets/themes/Taberna/img/stones/demacia/espada.svg";
                    else if (url.includes("escudo")) url = "assets/themes/Taberna/img/stones/demacia/escudo.svg";
                    else if (url.includes("cavalo")) url = "assets/themes/Taberna/img/stones/demacia/cavalo.svg";
                    else if (url.includes("bandeira")) url = "assets/themes/Taberna/img/stones/demacia/bandeira.svg";
                    else if (url.includes("martelo")) url = "assets/themes/Taberna/img/stones/demacia/martelo.svg";
                    else if (url.includes("Balanca")) url = "assets/themes/Taberna/img/stones/demacia/Balanca.svg";
                    else if (url.includes("Cara.png")) url = "assets/themes/Taberna/img/coins/classic/Cara.png"; // Coin fix
                    else if (url.includes("Coroa.png")) url = "assets/themes/Taberna/img/coins/classic/Coroa.png"; // Coin fix
                }
