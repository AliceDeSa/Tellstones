...
import { getContextualPhrase } from "./personality/MaestroProfile.js";
...
export class BotController {
    constructor(profileId = 'vigilante', skillLevel = SkillLevel.VETERANO) {
    ...
    decideMove(ctx) {
        ...
        const phrase = this.getContextualPhrase(action.type);
        if (phrase) {
    ...
    predictStone(slot, ctx) {
        ...
        if (probability > 0) {
            ...
            if (Math.random() < (errorMod - 1.0)) {
                ...
                finalGuess = ((_a = sorted[2]) === null || _a === void 0 ? void 0 : _a[0]) || finalGuess;
            }
        }
        else {
    ...
    // ==================== MÉTODOS PRIVADOS ====================
    getContextualPhrase(actionType) {
        try {
...
window.BotBrain = BotController; // Alias para compatibilidade
