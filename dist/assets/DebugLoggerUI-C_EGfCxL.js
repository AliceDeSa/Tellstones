import{L as o,a as n}from"./index-DiGHANEN.js";class x{constructor(){this.isOpen=!1,o.isDev&&this.init()}init(){const e=document.createElement("button");e.innerText="🐞",e.title="Debug Panel",e.style.cssText=`
            position: fixed;
            bottom: 10px;
            right: 10px;
            z-index: 9100;
...
//# sourceMappingURL=DebugLoggerUI-C_EGfCxL.js.map
